...
class LoanScheduleUploadWizard {
    ...
    _handle_file(file) {
        ...
        .then(resp => {
            ...
            this.file_doc = result.file_doc_name;   // correctly echoed back from API
            this._render_step2();
        })
        .catch(err => {
    ...
    _render_step2() {
            ...
            <div class="loan-upload-wizard" style="max-width:900px; margin:30px auto;">
                ...
                <div class="card shadow-sm p-4 mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="field-principal_account"></div>
        ...
        this._make_link_field("field-principal_account", "Principal Repayment Account", "Account",  "principal_account");
    ...
    _get_account_values() {
        return {
            ...
            principal_account: this._field_principal_account?.get_value(),
    ...
    _create_schedule() {
        ...
        const missing = ["loan_account", "interest_account", "principal_account", "bank_account"]
            .filter(k => !accounts[k]);
